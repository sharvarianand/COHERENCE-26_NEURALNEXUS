...
import { Play, Mail, Clock, GitBranch, Square, Search, UserCheck } from "lucide-react";
...
const nodeItems = [
  ...
  { type: "human_review", label: "Human Review", icon: UserCheck, color: "text-amber-600 bg-amber-100" },
